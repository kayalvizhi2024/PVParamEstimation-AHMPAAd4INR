function [BestX,BestF,HisBestFit,VisitTable]=hybrid_AHA_mpa_solar_NR4_partial(MaxIt,nPop)
%==========================================================================
...
% Problem dimension and bounds
    ...
    for i=1:nPop
        ...
        PopFit(i)=objfunddnr4_partial(PopPos(i,:),It);
    end
    ...
    for It=1:MaxIt
        ...
        for i=1:nPop
            ...
            if rand<0.5   % Sine Cosine Guided foraging
                ...
                newPopFit=objfunddnr4_partial(newPopPos,It);
...
%                 newPopPos= PopPos(i,:)+randn*DirectVector(i,:).*PopPos(i,:);
        ...
        if mod(It,2*nPop)==0 % Opposition based Migration foraging
            ...
            PopFit(MigrationIndex)=objfunddnr4_partial(PopPos(MigrationIndex,:),It)
            oppPopFit=objfunddnr4_partial(oppPopPos,It);
