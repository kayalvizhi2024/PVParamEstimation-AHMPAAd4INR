function [BestX, BestF, HisBestFit, VisitTable] = hybrid_AHA_mpa_solar_NR4(MaxIt, nPop)
%==========================================================================
...
for i = 1:nPop
    PopFit(i) = objfunddnr4(PopPos(i,:), 1);
end
...
for It = 1:MaxIt
    ...
    for i = 1:nPop
        ...
        newPopFit = objfunddnr4(newPopPos, It);
    ...
    if mod(It, 2*nPop) == 0
        ...
        PopFit(MigrationIndex) = objfunddnr4(PopPos(MigrationIndex,:), It);
