function [BestX, BestF, HisBestFit, VisitTable] = hybrid_AHA_mpa_single_NR4(MaxIt, nPop)
%==========================================================================
...
for i = 1:nPop
    PopFit(i) = objfunsdnr4(PopPos(i,:), 1);
end
...
for It = 1:MaxIt
    ...
    for i = 1:nPop
        ...
        newPopFit = objfunsdnr4(newPopPos, It);
    ...
    if mod(It, 2*nPop) == 0
        ...
        PopFit(MigrationIndex) = objfunsdnr4(PopPos(MigrationIndex,:), It);
        oppPopFit = objfunsdnr4(oppPopPos, It);
