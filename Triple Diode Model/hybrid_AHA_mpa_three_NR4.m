function [BestX,BestF,HisBestFit,VisitTable]=hybrid_AHA_mpa_three_NR4(MaxIt,nPop)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:nPop
        ...
        PopFit(i)=objfuntdnr4(PopPos(i,:),It);
    end
    ...
    for It=1:MaxIt
        ...
        for i=1:nPop
            ...
            if rand<0.5   % Sine Cosine Guided foraging
                ...
                newPopFit=objfuntdnr4(newPopPos,It);
...
%                 newPopPos= PopPos(i,:)+randn*DirectVector(i,:).*PopPos(i,:);
        ...
        if mod(It,2*nPop)==0 % Opposition based Migration foraging
            ...
            PopFit(MigrationIndex)=objfuntdnr4(PopPos(MigrationIndex,:),It);
            oppPopFit=objfuntdnr4(oppPopPos,It);
