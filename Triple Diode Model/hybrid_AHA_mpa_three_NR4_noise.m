function [BestX,BestF,HisBestFit,VisitTable]=hybrid_AHA_mpa_three_NR4_noise(MaxIt,nPop)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:nPop
        ...
        PopFit(i)=objfuntdnr4_noise(PopPos(i,:),It);
    end
    ...
    for It=1:MaxIt
        ...
        for i=1:nPop
            ...
            if rand<0.5   % Sine Cosine Guided foraging
                ...
                newPopFit=objfuntdnr4_noise(newPopPos,It);
...
%                 newPopPos= PopPos(i,:)+randn*DirectVector(i,:).*PopPos(i,:);
        ...
        if mod(It,2*nPop)==0 % Opposition based Migration foraging
            ...
            PopFit(MigrationIndex)=objfuntdnr4_noise(PopPos(MigrationIndex,:),It);
            oppPopFit=objfuntdnr4_noise(oppPopPos,It);
